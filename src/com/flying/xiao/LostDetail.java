...
public class LostDetail extends BaseActivity
{
	...
	private void initView()
	{
		...
		if (con.isMeCollecte())
			mHeadRightView.setImageDrawable(resources.getDrawable(R.drawable.head_favorite_y));
		else
			mHeadRightView.setImageDrawable(resources.getDrawable(R.drawable.head_favorite));
	...
	private void initData()
	{
		...
		mHandler = new Handler()
		{
			...
			public void handleMessage(Message msg)
			{
				...
				case Constant.HandlerMessageCode.CONTENT_DETAIL_LOAD_DATA_ERROR:
					...
					UIHelper.ToastMessage(LostDetail.this, R.string.msg_load_is_null);
					break;
				...
				case Constant.HandlerMessageCode.USER_NOT_LOGIN:
					UIHelper.ToastMessage(LostDetail.this, R.string.user_login_out_of_date);
		...
		NetControl.getShare(LostDetail.this).getContentDetail(Constant.ContentType.CONTENT_TYPE_LOST,
				con.getId(), mHandler);
	...
	private OnClickListener listener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.market_detail_footer_btn_call:
				UIHelper.showCallPhone(LostDetail.this, mPhone.getText().toString());
				break;
			case R.id.market_detail_footer_btn_msg:
				UIHelper.showSendMsg(LostDetail.this, mPhone.getText().toString());
				break;
		...
		public Object instantiateItem(ViewGroup container, int position)
		{
			...
			images.get(position).setOnClickListener(new OnClickListener()
			{
				...
				public void onClick(View v)
				{
					...
					UIHelper.showFullScreenPicture(LostDetail.this, imageList, position_,
	...
	private View.OnClickListener collectClickListener = new View.OnClickListener()
	{
		...
		public void onClick(View v)
		{
			NetControl.getShare(LostDetail.this).collectOperate(con.getId(), con.isMeCollecte(), mHandler);
