...
public class SearchActivity extends BaseActivity
{
	...
	private void initView()
	{
		...
		search_catalog_lost.setOnClickListener(this.searchBtnClick(search_catalog_lost,
				Constant.ContentType.CONTENT_TYPE_LOST));
		search_catalog_market.setOnClickListener(this.searchBtnClick(search_catalog_market,
				Constant.ContentType.CONTENT_TYPE_MARKET));
		search_catalog_user.setOnClickListener(this.searchBtnClick(search_catalog_user, -1));
		search_catalog_ask.setOnClickListener(this.searchBtnClick(search_catalog_ask,
				Constant.ContentType.CONTENT_TYPE_ASK));
		search_catalog_news.setOnClickListener(this.searchBtnClick(search_catalog_news,
		...
		mContentAdapter = new ListViewMainContentAdapter(this, lvSearchContentData,
				R.layout.main_fragment_news_listitem);
		mMarketAdapter = new ListViewMainContentAdapter(this, lvSearchContentData,
				R.layout.main_fragment_market_listitem, true);
		mUserAdapter = new ListViewCommunityAdapter(this, lvSearchUserData,
		...
		mlvSearch.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				{
					UIHelper.showContentInfo(SearchActivity.this,
							(XContent) lvSearchContentData.get(position), type);
				}
			}
		});
