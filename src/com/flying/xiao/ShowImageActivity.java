...
public class ShowImageActivity extends BaseActivity
{
	...
	private OnClickListener listener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.show_image_scan:
				...
				{
					UIHelper.showFullScreenPicture(ShowImageActivity.this, pictureUrls, 0,
							Constant.PictureType.TYPE_NATIVE);
				} else
				{
					UIHelper.ToastMessage(ShowImageActivity.this, R.string.picture_unchecked);
				}
				break;
			default:
				break;
	...
	// Toast.makeText(this, "选中 " + adapter.getSelectItems().size() + " item",
