		...
		mHeadRightBtn.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if (appContext.isLogin())
				{
					...
					NetControl.getShare(Suggestion.this).suggest(null, null, null,
							String.valueOf(userInfo.getId()), suggesstions.getText().toString(), mHandler);
				} else
				{
					...
					mProgress = ProgressDialog.show(v.getContext(), null, "保存中···", true, true);
					if (isEmail)
						NetControl.getShare(Suggestion.this).suggest(info.getText().toString(), null, null,
								name.getText().toString(), suggesstions.getText().toString(), mHandler);
					else
						NetControl.getShare(Suggestion.this).suggest(null, info.getText().toString(), null,
								name.getText().toString(), suggesstions.getText().toString(), mHandler);
				}
			}
		});
