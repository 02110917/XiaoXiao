...
public class FullScreenPictureAdapter extends PagerAdapter
{
	...
	public FullScreenPictureAdapter(ArrayList<String> pictureUrls, Context context)
	{
	...
	public View instantiateItem(ViewGroup container, int position)
	{
		...
		{
			ImageManager2.from(context).displayImage(photoView, url, R.drawable.picture_bg);
		} else
		{
			// 利用NativeImageLoader类加载本地图片
			Bitmap bitmap = NativeImageLoader.getInstance().loadNativeImage(url, null, photoView,
