...
//	public final static String WSURI = "ws://192.168.23.1:8080/XiaoServer/websocket";
	...
	// public final static String WSURI =
	// "ws://xiaolife.net/XiaoServer/websocket";
	// public final static String WSURI =
	// "ws://zhangmin.web.myjhost.net/XiaoServer/websocket";
	// public final static String WSURI =
	// "ws://192.168.43.186:8080/XiaoServer/websocket";
	public final static String URL_MAIN_GET_CONTENT = HOST + "/XiaoServer/servlet/GetContent";
	// public final static String URL_MAIN_NEWS =HOST+
	// "/XiaoServer/servlet/GetContent?type=news";
	// public final static String URL_MAIN_LOST =HOST+
	// "/XiaoServer/servlet/GetContent?type=lost";
	// public final static String URL_MAIN_DIARY =HOST+
	// "/XiaoServer/servlet/GetContent?type=diary";
	// public final static String URL_MAIN_MARKET =HOST+
	// "/XiaoServer/servlet/GetContent?type=market";
	// public final static String URL_MAIN_ASK =HOST+
	// "/XiaoServer/servlet/GetContent?type=ask";
	...
	public final static String URL_GETUSERINFOSBYNAME = HOST + "/XiaoServer/servlet/GetUserInfosByUserNames";
