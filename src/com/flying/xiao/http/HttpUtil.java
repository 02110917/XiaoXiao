...
public class HttpUtil
{
	...
	public static XUserInfo login(AppContext appContext, String username, String pwd) throws AppException
	{
		...
		try
		{
			...
			if (results.length == 2)
			{
				...
				Gson gson = new Gson();
				List<XUserInfo> userInfos = gson.fromJson(friendJson, new TypeToken<List<XUserInfo>>()
	 ...
	 * @throws AppException
	 */
	public static XMessage pubMessage(AppContext appContext, long userId, String messageInfo,int messageReplyId,int messageMainId)
			throws AppException
	{
		Map<String, String> params = new HashMap<String, String>();
		params.put("userId", userId + "");
	...
	public static List<XUserInfo> getMyFriends(AppContext appContext) throws AppException
	{
		List<XUserInfo> userList = null;
		String result = "";
